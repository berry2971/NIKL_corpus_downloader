...
for _ in tqdm(range(1495)):
    ...
    try:
        ...
        # 동의란 버튼 클릭
        accept_btn = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.ID, 'agreementYn')))
        accept_btn.click()
        outer_download_btn = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="agreementDownloadLayer"]/div[5]/a[1]')))
